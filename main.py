...
screen = pygame.display.set_mode((constants.SCREEN_WIDTH, constants.SCREEN_HEIGHT))#izveido display screen
pygame.display.set_caption("Deep Descent")

#clock for maintaining fps
clock = pygame.time.Clock()

#definee game variables
level = 1
start_game = False
pause_game = False
start_intro = False
...
#definē player movement variables
moving_left = False
moving_right = False
moving_up = False
moving_down = False
...
shot_fx = pygame.mixer.Sound("assets/audio/gunshot.mp3")
...
heal_fx = pygame.mixer.Sound("assets/audio/heal.mp3")
heal_fx.set_volume(1)

damaged_fx = pygame.mixer.Sound("assets/audio/damaged.mp3")
damaged_fx.set_volume(0.5)


#load button images
logo_img = scale_img(pygame.image.load("assets/images/buttons/logo.png").convert_alpha(), constants.BUTTON_SCALE*1.5)
...
#load potion image
red_potion = scale_img(pygame.image.load("assets/images/items/potion.png").convert_alpha(), constants.POTION_SCALE)
...
mob_animations = []
mob_types = ["guy", "zombie", "big_demon"]
...
for mob in mob_types:
    ...
    for animation in animation_types:
        ...
        temp_list = []
        for i in range(4): #cikls lai ielādētu visus attēlus animācijai un scale them to needed size
            img = pygame.image.load(f"assets/images/characters/{mob}/{animation}/{i}.png").convert_alpha() #removes bg
...
for row in range(constants.ROWS):
    r = [-1] * constants.COLS
    world_data.append(r)
#load in level data in create world
...
start_button = Button(constants.SCREEN_WIDTH // 2 - 145, constants.SCREEN_HEIGHT // 2, start_img)
exit_button = Button(constants.SCREEN_WIDTH // 2 - 145, constants.SCREEN_HEIGHT // 2 + 150, exit_img)
restart_button = Button(constants.SCREEN_WIDTH // 2 - 145, constants.SCREEN_HEIGHT // 2 - 50, restart_img)
resume_button = Button(constants.SCREEN_WIDTH // 2 - 145, constants.SCREEN_HEIGHT // 2 - 150, resume_img)
logo = Button(constants.SCREEN_WIDTH // 2 - 520, constants.SCREEN_HEIGHT // 2 - 380, logo_img)
#main spēles loop
run = True
while run:
    # kontrolē fps
